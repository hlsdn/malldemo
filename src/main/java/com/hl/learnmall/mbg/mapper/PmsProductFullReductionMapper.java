...
import com.hl.learnmall.mbg.modal.PmsProductFullReductionExample;
...
public interface PmsProductFullReductionMapper {
    ...
    //新加的测试
   // void listAll(ResultHandler<PmsProductFullReduction> handler);
    List<PmsProductFullReduction> listAll();
    List<PmsProductLadder>listAllTable(@Param("l1") int l1,@Param("l2") int l2);
    int CountRow();
}